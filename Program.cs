...
namespace swordgroup
{
    internal partial class Program
    {
        ...
        public static void DisplayAnalysisResults(string fileContent, bool isCaseSensitive)
        {
            string strippedContent = WhiteSpaceRgx().Replace(fileContent, "");

            AnalysisResult result = (new CharFrequency() { caseSensitive = isCaseSensitive }).CalculateStats(strippedContent);
            Console.WriteLine(
        ...
        [GeneratedRegex("\\s+")]
        private static partial Regex WhiteSpaceRgx();
    }
}
